...
class InOrderThreadedBinaryTree extends BaseBinaryTree {
    ...
    traverse () {
        perf.start('traverse-in-order-threaded-binary-tree', this.values);
        ...
        perf.end('traverse-in-order-threaded-binary-tree', list);
        perf.print('traverse-in-order-threaded-binary-tree');
        return list;
    }
}
